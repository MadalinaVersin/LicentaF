...
namespace ForAnimalsApplication.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required(ErrorMessage = "Este obligatoriu sa introduceti o parola!")]
        [StringLength(100, ErrorMessage = "Parola trebuie sa aiba cel putin {2} caractere!", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Password")]
        public string Password { get; set; }
